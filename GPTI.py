...
class GPT:
    def __init__(self,who="",model="gpt-3.5-turbo",temp=1,api_key="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"): 
        """
    ...
    def Completion(self, prompt, cont=False, temp=None, topP=1, max_tokens=70, F_penalty=1.2, P_penalty=1 ):
        ...
        """
        openai.api_key = "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"
